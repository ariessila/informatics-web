                                ...
                                <?=form_open_multipart(admin_url('headline/edit/'.$data->id_headline), array('id' => 'form1'))?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="judul_en" class="form-control" placeholder="Judul Headline" value="<?=set_value('judul_en', $data->judul_en)?>" required="true" />
                                            <?=form_error('judul_en')?>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="deskripsi_en" class="form-control" placeholder="Deskripsi Headline" value="<?=set_value('deskripsi_en', $data->deskripsi_en)?>" />
                                     ...
                                     <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <?=form_dropdown('id_blog', $blogs, set_value('id_blog', $data->id_blog), 'class="form-control"')?>
                                            <?=form_error('id_blog')?>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="external" class="form-control" placeholder="External Link" value="<?=set_value('external', $data->external)?>" />
                                            <?=form_error('external')?>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <img class="img-thumbnail img-responsive" id="uploadgambar" src="<?=upload_url('headline/thumbs').(empty($data->gambar) ? 'no_image.png' : $data->gambar)?>" width="100%" alt="Upload Gambar" />
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="form-group">
