				...
				<div class="col-lg-8 post-list">
                    <div class="row">
                        ...
                        foreach ($blogs as $blogs) {
                            $isi_blogs = substr(strip_tags($blogs->isi_id), 0, 80).'...';
                        ?>
                        <div class="col-lg-6 post-list">
                            <div class="post-item">
                                ...
                                <div class="post-content post-content-all">
                                    <h3><a href="<?=site_url('berita/'.$blogs->slug_id)?>"><?=$blogs->judul_id?></a></h3>
				...
				<div class="col-sm-8 col-md-5 col-lg-4 col-xl-3 offset-xl-1 offset-0 pl-xl-0 sidebar">
					...
					<div class="widget" id="search-wid">
                        <form id="search-additional-form" method="GET" class="search-widget">
                            <input type="text" name="q" value="<?=($this->input->get('q', TRUE) ? $this->input->get('q', TRUE) : '')?>" placeholder="Cari Berita..." class="form-control"/>
