					...
					<div class="row">
						<div class="col-lg-9">
							<div class="section-title">
								<h3>Staff Administrasi dan Laboratorium</h3>
							</div>
						</div>
						<div class="col-lg-3 widget" style="margin-left: 0px;">
							<form id="search-additional-form" method="GET" class="search-widget">
								<input type="text" name="q" value="<?=($this->input->get('q', TRUE) ? $this->input->get('q', TRUE) : '')?>" placeholder="Cari Staff..." class="form-control"/>
